...
public class Distribution_VisualiserMessage extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Distribution_VisualiserMessage() {
		...
		btnMsgEnvoyer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Distribution_MessageEnvoye frame = new Distribution_MessageEnvoye();
				frame.setVisible(true);
			}
		});
